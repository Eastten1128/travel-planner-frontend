...
const MainA = () => {
  ...
  // 페이지 레이아웃: 좌측 사이드바 + 검색 영역 + 우측 지도/상세 패널
  return (
    <>
      <Navbar />
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-8">
          <div className="flex flex-col gap-4 lg:flex-row">
            ...
            <div className="flex flex-1 flex-col gap-4 lg:flex-row">
              ...
              <div className="relative flex-1 rounded-3xl bg-white p-4 shadow-sm ring-1 ring-gray-100 lg:p-6">
                <div className="mb-3 flex items-center justify-between">
                  <h2 className="text-xl font-bold text-gray-900">지도</h2>
                </div>
                <div className="h-[480px] w-full overflow-hidden rounded-2xl bg-gray-50 shadow-inner lg:h-[560px]">
                  <GoogleMap
